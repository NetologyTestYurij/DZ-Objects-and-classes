class Student:
    ...
    def rate_lecturer(self, lector, course, grade):
        if (isinstance(lector, Lecture) and course in self.courses_in_progress
...
student1 = Student('Алёша', 'Попович', 'муж')
student1.courses_in_progress += ['Python']
student1.finished_courses += ['Git']

student2 = Student('Жанна', 'Дарк', 'жен')
student2.courses_in_progress += ['Java']
student2.finished_courses += ['Git']

reviewer1 = Reviewer('Александр', 'Пушкин')
reviewer1.courses_attached += ['Python']

reviewer2 = Reviewer('Марина', 'Цветаева')
reviewer2.courses_attached += ['Java']

lecturer1 = Lecture('Виктор', 'Черномырдин')
lecturer1.courses_attached += ['Python']

lecturer2 = Lecture('Клара', 'Цеткин')
